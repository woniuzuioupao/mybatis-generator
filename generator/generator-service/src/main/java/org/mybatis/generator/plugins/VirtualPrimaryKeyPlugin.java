...
public class VirtualPrimaryKeyPlugin extends PluginAdapter {
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.Plugin#validate(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.PluginAdapter#initialized(org.mybatis.generator.util.IntrospectedTable)
     */
    @Override
