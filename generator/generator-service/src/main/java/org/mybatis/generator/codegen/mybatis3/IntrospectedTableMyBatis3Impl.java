...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.IntrospectedTable#calculateGenerators(java.util.List, org.mybatis.generator.util.ProgressCallback)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.IntrospectedTable#getGeneratedJavaFiles()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.IntrospectedTable#getGeneratedXmlFiles()
     */
    @Override
    public List<GeneratedXmlFile> getGeneratedXmlFiles() {
        ...
        if (xmlMapperGenerator != null) {
            ...
            Document document1 = xmlMapperGenerator.getDocumentEmpty();
            GeneratedXmlFile gxf1 = new GeneratedXmlFile(document1,
                    "customer" + getMyBatis3XmlMapperFileName(), getMyBatis3XmlMapperPackage(),
                    context.getSqlMapGeneratorConfiguration().getTargetProject(),
                    true, context.getXmlFormatter());
            if (context.getPlugins().sqlMapGenerated(gxf1, this)) {
                answer.add(gxf1);
            }
        }
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.IntrospectedTable#getGenerationSteps()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.IntrospectedTable#isJava5Targeted()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.util.IntrospectedTable#requiresXMLGenerator()
     */
    @Override
